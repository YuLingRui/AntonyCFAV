...
int run(int argc, char **argv) {
    ...
    if (nb_output_files <= 0 && nb_input_files == 0) {
        ...
        av_log(NULL, AV_LOG_WARNING, "Use -h to get full help or, even better, run 'man %s'\n",
               program_name);
        LOGI("FFmpegUtil", "Use -h to get full help or, even better, run 'man %s'\n", program_name);
        exit_program(1);
    }
    ...
    if (nb_output_files <= 0) {
        ...
        LOGI("FFmpegUtil", "At least one output file must be specified\n");
        exit_program(1);
    }
    ...
    if (do_benchmark) {
        ...
        LOGI("FFmpegUtil", "bench: utime=%0.3fs\n", ti / 1000000.0);
    }
